...
class DeleteSalary extends Component {
    constructor(props) {
  ...
  delete = () => {
    ...
    var SearchAPI = "http://10.0.2.2:8081/appJson/lamia/deleteSalary.php";
                var header = {
  ...
  render () {
    ...
    >
        <View style ={styles.header} >
            ...
            <Text style ={styles.headerText}>Delete salary Payment</Text>
        </View>
        ...
        <View style ={styles.list}>
          ...
          <View style ={styles.row}>
            ...
            <Text style ={styles.data}>{this.props.navigation.state.params.payment_from}</Text>
          </View>
        </View>
