...
class DeleteLoan extends Component {
  ...
  delete = () => {
    ...
    var SearchAPI = "http://10.0.2.2:8081/appJson/lamia/deleteLoan.php";
                var header = {
  ...
  render () {
    ...
    >
        <View style ={styles.header} >
            ...
            <Text style ={styles.headerText}>Delete Loan</Text>
        </View>
        ...
        <View style ={styles.list}>
          ...
          <View style ={styles.row}>
            ...
            <Text style ={styles.data}>{this.props.navigation.state.params.return_date}</Text>
          </View>
        ...
        <TouchableOpacity onPress={this.delete}  style ={ styles.button} >
            <View style ={ styles.passContainer}>
                <Text style ={styles.passText}>Delete Loan</Text>
            </View>
        </TouchableOpacity>
