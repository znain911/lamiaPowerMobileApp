...
class AddSalary extends Component {
  ...
  addPayment = () => {
    ...
    if (this.state.name === ''){
      alert('employee name should not empty');
    }else{
       ...
       var SearchAPI = "http://10.0.2.2:8081/appJson/lamia/addSalary.php";
                var header = {
                ...
                var Data = {
                    id: this.props.navigation.state.params.officeid,
  ...
  render(){
    ...
    >
        <View style ={styles.header} >
            ...
            <Text style ={styles.headerText}>ADD Salary Payment</Text>
        </View>

        <Text style ={styles.pd}>Employee Name *: </Text>
